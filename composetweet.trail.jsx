...
//         <Header postButton={handleTweet} />
//         <ComposeTweetMain text={details.Post.text} onChangeText={onChangeText} />
...
//      <div className="flex flex-col items-center bg-neutral/1000  justify-start h-screen">
//   <Header postButton={handleTweet} />
//  <ComposeTweetMain text={tweetText} onChangeText={onChangeText} />
//  {console.log(tweet)}
//  <Footer />
// </div>
