  ...
  const trailData = [
    {
      ...
      Post: {id:1, 
        text:" Hey, have you checked out the new sports car that just hit the market?", 
        postedAt:'', 
    ...
    },
    {
      ...
      Post: {id:2, 
        text:"Well, I still love cars, but there's something about the freedom and adrenaline rush you get on a motorcycle. I recently got myself a new superbike, and it's a whole different experience.", 
        postedAt:'', 
    ...
    },
    {
      ...
      Post: {id:3, 
        text:"True, cruisers have that timeless charm. But you can't beat the agility of a sportbike, especially when you're carving through twisty roads.", 
        postedAt:'', 
    ...
    },
    {
      ...
      Post: {id:4, 
        text:"Yeah, electric cars are making quite a statement. I've been eyeing the new Tesla Roadster. The acceleration on that thing is mind-blowing, and the fact that it's all electric is just the future knocking on our doors.", 
        postedAt:'', 
    ...
    },
    {
      ...
      Post: {id:5, 
        text:"Great the tweet functionality is working now, the list is being rendered", 
        postedAt:'', 
